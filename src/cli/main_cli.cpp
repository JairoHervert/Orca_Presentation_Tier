...
// g++ -D_WIN32_WINNT=0x0A00 -I include/third_party -I include src/cli/main_cli.cpp src/app/commands/init.cpp src/app/commands/clone.cpp src/app/commands/push.cpp src/app/commands/config.cpp src/app/commands/log.cpp src/app/commands/revoke.cpp src/codec/json_codec.cpp src/transport/client_https.cpp src/app/responses_handlers/init_handler.cpp src/app/responses_handlers/clone_handler.cpp src/app/responses_handlers/push_handler.cpp src/app/responses_handlers/config_handler.cpp src/app/responses_handlers/log_handler.cpp src/app/responses_handlers/revoke_handler.cpp src/codec/downloader.cpp src/transport/http_getter.cpp src/codec/unpacker.cpp src/codec/hasher.cpp src/codec/comparator.cpp src/codec/packer.cpp -o orca -lssl -lcrypto -lws2_32 -lcrypt32 -lcryptopp
...
int main(int argc, char** argv) {
   ...
   revoke->add_option("-f,--file", revoke_file, "Archivo especifico (Opcional)");
   ...
   if (log->parsed()) {
    ...
    if (revoke->parsed()) {
      client::cmd::run_revoke(repo_name, user_email, revoke_file);
   }
